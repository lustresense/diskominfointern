  ...
  return (
    <section className="border-y border-[#dce7df] bg-[#f3f8f4] px-4 py-20 md:py-28">
      <div className="mx-auto max-w-5xl">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#0f5f3f]/70">Tentang SIMRP</p>
        ...
        <p className="mt-6 max-w-3xl text-sm leading-relaxed text-[#4f5d56] md:text-base">
          SIMRP adalah platform yang mencatat, memverifikasi, dan mengukur kontribusi kegiatan kampung secara terstruktur.
